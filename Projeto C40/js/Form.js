class Form {
  constructor() {
    ...
    this.playButton = createButton("Pronto");
  ...
  setElementsPosition() {
    ...
    this.resetButton.position(width  - 250,  580);
  ...
  handleMousePressed() {
    this.playButton.mousePressed(() => {
      ...
      this.playButton.hide();
      var message = `
      Olá ${this.input.value()}, bem vindo ao CorreCarro - Velozes e Selvagens!
      </br>Por favor espere o outro jogador entrar...`;
